              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: `1px solid ${active ? '#0F172A' : 'rgba(13,148,136,0.3)'}`,
          ...
          >
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                ...
                <div style={{ fontSize: 12, color: '#CCFBF1', fontFamily: 'monospace' }}>USER STORE QUERY</div>
              </div>
              ...
              <div style={{ padding: 20, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                  <span style={{ fontSize: 11, color: '#CCFBF1', fontWeight: 800, fontFamily: 'monospace' }}>FINGUARD AI ANALYSIS</span>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 11, color: '#CCFBF1', marginTop: 20 }}>
              <Sparkles size={12} color="#0D9488" /> 24/7 AI Chat Helper Active
            </div>
          </div>
