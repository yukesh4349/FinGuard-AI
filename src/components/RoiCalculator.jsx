        ...
        >
          ...
          <div style={{
            ...
            <div style={{ marginBottom: 28 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                ...
                <span style={{ color: '#0D9488', fontSize: 17, fontWeight: 800 }}>${monthlyRevenue.toLocaleString()}</span>
              </div>
              <input
            ...
            <div style={{ marginBottom: 28 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                ...
                <span style={{ color: '#0284C7', fontSize: 17, fontWeight: 800 }}>{invoiceCount} Docs</span>
              </div>
              <input
                type="range" min="50" max="2000" step="25"
                value={invoiceCount}
                onChange={(e) => setInvoiceCount(Number(e.target.value))}
                style={{ width: '100%', accentColor: '#0284C7', cursor: 'pointer', height: 8, borderRadius: 4 }}
              />
              <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 6 }}>
            ...
            <div style={{
              ...
              <Sparkles size={16} color="#0D9488" style={{ flexShrink: 0, marginTop: 2 }} />
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ color: '#0D9488', fontSize: 13, fontWeight: 700, marginBottom: 4 }}>
                Weekly Operational Hours Saved
              </p>
              <div style={{ color: '#0F172A', fontSize: 40, fontWeight: 800, letterSpacing: '-0.5px', lineHeight: 1 }}>
                {hoursSavedPerWeek}
                <span style={{ fontSize: 20, fontWeight: 600, marginLeft: 6, color: '#0D9488' }}>hrs/wk</span>
              </div>
