...
CREATE TABLE public.staff (
    ...
    user_id VARCHAR(100) NOT NULL REFERENCES public.users(user_id) ON DELETE CASCADE,
...
CREATE POLICY public_staff_policy ON public.staff FOR ALL USING (true);
CREATE POLICY public_inventory_policy ON public.inventory FOR ALL USING (true);
CREATE POLICY public_invoices_policy ON public.invoices FOR ALL USING (true);
CREATE POLICY public_customer_bills_policy ON public.customer_bills FOR ALL USING (true);
CREATE POLICY public_transactions_policy ON public.transactions FOR ALL USING (true);
CREATE POLICY public_expenses_policy ON public.expenses FOR ALL USING (true);
CREATE POLICY public_fraud_alerts_policy ON public.fraud_alerts FOR ALL USING (true);
